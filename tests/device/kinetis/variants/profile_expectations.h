...
static const KinetisExpectedBlock expected_mkv10z1287_blocks[] = {
    EXPECTED_BLOCK(FLASH_CONFIG, 0x00000400u, 0x0eu), EXPECTED_BLOCK(DMA, 0x40008000u, 0x1100u),
    EXPECTED_BLOCK(FTFA, 0x40020000u, 0x2cu),         EXPECTED_BLOCK(DMAMUX, 0x40021000u, 0x08u),
    EXPECTED_BLOCK(FTM3, 0x40026000u, 0x9cu),         EXPECTED_BLOCK(FTM4, 0x40027000u, 0x9cu),
    EXPECTED_BLOCK(FTM5, 0x40028000u, 0x9cu),         EXPECTED_BLOCK(SPI0, 0x4002c000u, 0x140u),
    EXPECTED_BLOCK(PDB1, 0x40031000u, 0x19cu),        EXPECTED_BLOCK(CRC, 0x40032000u, 0x0cu),
    EXPECTED_BLOCK(PDB0, 0x40036000u, 0x19cu),        EXPECTED_BLOCK(FTM0, 0x40038000u, 0x9cu),
    EXPECTED_BLOCK(FTM1, 0x40039000u, 0x9cu),         EXPECTED_BLOCK(FTM2, 0x4003a000u, 0x9cu),
    EXPECTED_BLOCK(ADC0, 0x4003b000u, 0x70u),         EXPECTED_BLOCK(ADC1, 0x4003c000u, 0x70u),
    EXPECTED_BLOCK(DAC0, 0x4003f000u, 0x24u),         EXPECTED_BLOCK(LPTMR0, 0x40040000u, 0x10u),
    EXPECTED_BLOCK(SIM, 0x40047000u, 0x1104u),        EXPECTED_BLOCK(PORTA, 0x40049000u, 0xa4u),
    EXPECTED_BLOCK(PORTB, 0x4004a000u, 0xa4u),        EXPECTED_BLOCK(PORTC, 0x4004b000u, 0xa4u),
    EXPECTED_BLOCK(PORTD, 0x4004c000u, 0xa4u),        EXPECTED_BLOCK(PORTE, 0x4004d000u, 0xa4u),
    EXPECTED_BLOCK(WDOG, 0x40052000u, 0x18u),         EXPECTED_BLOCK(EWM, 0x40061000u, 0x06u),
    EXPECTED_BLOCK(MCG, 0x40064000u, 0x0cu),          EXPECTED_BLOCK(OSC, 0x40065000u, 0x01u),
    EXPECTED_BLOCK(I2C0, 0x40066000u, 0x0cu),         EXPECTED_BLOCK(UART0, 0x4006a000u, 0x17u),
    EXPECTED_BLOCK(UART1, 0x4006b000u, 0x17u),        EXPECTED_BLOCK(CMP0, 0x40073000u, 0x06u),
    EXPECTED_BLOCK(CMP1, 0x40073008u, 0x06u),         EXPECTED_BLOCK(LLWU, 0x4007c000u, 0x10u),
    EXPECTED_BLOCK(PMC, 0x4007d000u, 0x03u),          EXPECTED_BLOCK(SMC, 0x4007e000u, 0x04u),
    EXPECTED_BLOCK(RCM, 0x4007f000u, 0x06u),          EXPECTED_BLOCK(GPIOA, 0x400ff000u, 0x18u),
    ...
    EXPECTED_BLOCK(MTB, 0xf0000000u, 0x1000u),        EXPECTED_BLOCK(MTBDWT, 0xf0001000u, 0x1000u),
    EXPECTED_BLOCK(ROM, 0xf0002000u, 0x1000u),        EXPECTED_BLOCK(MCM, 0xf0003000u, 0x44u),
    EXPECTED_BLOCK(MMDVSQ, 0xf0004000u, 0x14u),       EXPECTED_BLOCK(FGPIOA, 0xf8000000u, 0x18u),
    EXPECTED_BLOCK(FGPIOB, 0xf8000040u, 0x18u),       EXPECTED_BLOCK(FGPIOC, 0xf8000080u, 0x18u),
    EXPECTED_BLOCK(FGPIOD, 0xf80000c0u, 0x18u),       EXPECTED_BLOCK(FGPIOE, 0xf8000100u, 0x18u),
};
...
static const KinetisExpectedProfile expected_profiles[] = {
    ...
    {.id = KINETIS_PROFILE_MKV10Z1287,
     ...
     .maximum_core_clock_hz = 75000000u,
     .external_irq_count = 32u,
     .blocks = expected_mkv10z1287_blocks,
     .block_count = EXPECTED_COUNT(expected_mkv10z1287_blocks)},
