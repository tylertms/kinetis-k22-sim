...
void k22_integration_test_expect_package_selection(TestState* state) {
    ...
    Kinetis* small_device = k22_integration_test_create_device(state, KINETIS_PACKAGE_LH_64_LQFP);
    ...
    Kinetis* large_device = k22_integration_test_create_device(state, KINETIS_PACKAGE_DC_121_XFBGA);
    ...
    Kinetis* limited_device =
        k22_integration_test_create_device(state, KINETIS_PACKAGE_FX_88_HVQFN);
    expect(state,
...
void k22_integration_test_expect_integrated_flash_swap(TestState* state) {
    Kinetis* device = k22_integration_test_create_f12_device(state, KINETIS_PACKAGE_MC_121_MAPBGA);
...
void k22_integration_test_expect_memory_domains(TestState* state) {
    Kinetis* device = k22_integration_test_create_f12_device(state, KINETIS_PACKAGE_LQ_144_LQFP);
...
void k22_integration_test_expect_package_serial_extensions(TestState* state) {
    Kinetis* small = k22_integration_test_create_f12_device(state, KINETIS_PACKAGE_LH_64_LQFP);
    ...
    Kinetis* large = k22_integration_test_create_f12_device(state, KINETIS_PACKAGE_MD_144_MAPBGA);
