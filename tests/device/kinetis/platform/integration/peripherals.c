...
static void expect_serial_dma_sources(TestState* state) {
    Kinetis* device = k22_integration_test_create_f12_device(state, KINETIS_PACKAGE_MD_144_MAPBGA);
...
static void expect_periodic_dma_trigger(TestState* state) {
    Kinetis* device = k22_integration_test_create_device(state, KINETIS_PACKAGE_DC_121_XFBGA);
    CortexM4* cpu = kinetis_cpu(device);
    ...
    kinetis_advance(device, k22_test_core_cycles_for_bus_cycles(device, 1u));
...
static void expect_sdhc_integration(TestState* state) {
    ...
    Kinetis* unsupported_device =
        k22_integration_test_create_f12_device(state, KINETIS_PACKAGE_LH_64_LQFP);
    ...
    Kinetis* sdhc_device =
        k22_integration_test_create_f12_device(state, KINETIS_PACKAGE_LK_80_LQFP);
