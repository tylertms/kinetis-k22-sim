...
int main(int argc, char** argv) {
    ...
    static const uint64_t expected_permitted[24] = {
        34760511u, 31693663u, 42017792u, 41792000u, 50331648u, 50331648u, 50331648u, 50331648u,
    ...
    static const uint64_t expected_executed[24] = {
        11466987u, 19110751u, 11515392u, 10762752u, 320256u,   2486784u,  2891040u,  0u,
    ...
    static const uint64_t expected_fingerprints[24] = {
        UINT64_C(2872044751015345655),  UINT64_C(1771842544788466165),
        UINT64_C(6814390124731425717),  UINT64_C(3290455884283818648),
