...
typedef enum {
    ...
    KINETIS_DATA_STOP_VLLS0,
    KINETIS_DATA_STOP_VLLS1,
...
typedef struct {
    ...
    bool (*flash_read)(void* context, uint32_t address, uint8_t byte_count,
    ...
    void (*dma_complete)(void* context, uint8_t channel, uint8_t request_source);
    void (*adc_complete)(void* context, uint8_t instance, uint8_t pretrigger);
} KinetisDataBus;
