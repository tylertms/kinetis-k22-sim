...
typedef enum {
    ...
    KINETIS_PERIPHERAL_FTM4,
    KINETIS_PERIPHERAL_FTM5,
    KINETIS_PERIPHERAL_PDB1,
    KINETIS_PERIPHERAL_MTB,
    KINETIS_PERIPHERAL_MTBDWT,
    KINETIS_PERIPHERAL_ROM,
    KINETIS_PERIPHERAL_MMDVSQ,
    KINETIS_PERIPHERAL_FGPIOA,
    KINETIS_PERIPHERAL_FGPIOB,
    KINETIS_PERIPHERAL_FGPIOC,
    KINETIS_PERIPHERAL_FGPIOD,
    KINETIS_PERIPHERAL_FGPIOE,
    KINETIS_PERIPHERAL_COUNT,
} KinetisPeripheralId;

typedef enum {
    KINETIS_CPU_ARCHITECTURE_ARMV6_M,
